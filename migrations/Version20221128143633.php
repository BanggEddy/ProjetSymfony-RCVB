 ...
 */
final class Version20221128143633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_adherent (categorie_id INT NOT NULL, adherent_id INT NOT NULL, INDEX IDX_A854B10ABCF5E72D (categorie_id), INDEX IDX_A854B10A25F06C53 (adherent_id), PRIMARY KEY(categorie_id, adherent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE entrainement DROP terrain');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entrainement ADD terrain VARCHAR(50) NOT NULL');
    }
}
